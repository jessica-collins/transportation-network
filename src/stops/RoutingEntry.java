 ...
 * destination.
 *
 * <p>This information includes the best intermediate stop to route
...
public class RoutingEntry {
    // the next stop to be visited in order to reach the destination stored
    // in this entry
    private Stop nextStop;

    // the cost (in Manhattan distance) required to reach the destination
    // stored in this entry
    private int cost;
    /**
     * Creates a new default RoutingEntry object.
     *
     * <p>The next stop should be stored as null, and the cost should be stored
    ...
    /**
     * Creates a new RoutingEntry object with the given next stop and cost
